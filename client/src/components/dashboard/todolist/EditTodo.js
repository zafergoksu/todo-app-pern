...
const EditTodo = ({ todo, setTodosChange }) => {
    ...
    return (
        <>
            ...
            <button type="button" className="btn btn-info btn-warning" data-toggle="modal" data-target={`#id${todo.todo_id}`} onClick={() => setDescription(todo.description)}>Edit</button>
